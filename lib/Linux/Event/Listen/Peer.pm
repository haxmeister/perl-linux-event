package Linux::Event::Listen::Peer;
use v5.36;
use strict;
use warnings;
...
Linux::Event::Listen::Peer - lazy accepted-peer address

=head1 DESCRIPTION

Each C<on_accept> callback receives this object. The packed sockaddr is retained
without conversion; textual address parsing occurs only when an address
accessor is used.
