...
sub _build_definition ($class, @args) {
    ...
    # The prefix width and endianness are fixed at declaration time, so the
    # pack template and the capacity limit are resolved once here rather than
    # rebuilt per frame.
